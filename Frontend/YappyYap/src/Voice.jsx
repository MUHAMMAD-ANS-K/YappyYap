...
export default function Voice() {
   ...
   const currentDuration = useRef(0)
    ...
    useEffect(()=>{
        ...
        // const websocket = new Websocket("ws://localhost:8000/voicews")
        return ()=>{    
            ...
            async function play_pause_audio(){      
                const element = document.querySelector(".audio-play");
                    element.addEventListener("loadedmetadata", ()=>{
                    })
                const movingDot= document.querySelector(".msg-bars-mover")
                    if (movingDot.style.transform == "translate(0px)" || movingDot.style.transform == "") {
                        duration.current = element.duration
                        dotMover.current("msg-bars-mover", duration.current)
                        barMover.current("msg-bar-underlay", duration.current/30)
                }
                if(element.paused) {
                            ...
                            <ul className="msgs">
                                <li className="chat-message-block">
                                    ...
                                    <span>
                                        ...
                                        <div className="audio">
                                        <audio src={audio2} className="audio-play"/> 
